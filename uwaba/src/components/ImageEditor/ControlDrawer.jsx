...
/**
 * Drawer pengaturan edit gambar — sama dengan aplikasi daftar:
 * Auto Crop (deteksi dokumen), Crop Manual, Kecerahan, Kontras, Rotasi.
 * Saat geser slider: backdrop transparan agar gambar tetap terlihat.
 */
            ...
            >
              ...
              <div className="px-4 pb-2 border-b border-white/20">
                <div className="flex items-center justify-between">
                  <h3 className="text-sm font-semibold text-white/95">Edit Gambar</h3>
                  <button
                    onClick={() => setIsOpen(false)}
