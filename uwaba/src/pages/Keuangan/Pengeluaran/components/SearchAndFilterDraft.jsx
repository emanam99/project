...
// Memoized Search and Filter Section untuk Draft (sama persis dengan Rencana)
const SearchAndFilterDraft = memo(({
  searchInput,
  onSearchInputChange,
  onSearchInputFocus,
  onSearchInputBlur,
...
SearchAndFilterDraft.displayName = 'SearchAndFilterDraft'

export default SearchAndFilterDraft
