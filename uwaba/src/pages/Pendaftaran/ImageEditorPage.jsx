...
function ImageEditorPage() {
  ...
  useEffect(() => {
    ...
    if (stateFile) {
      ...
      // Jika tidak ada file, kembali ke halaman sebelumnya
      const returnPage = sessionStorage.getItem('editorReturnPage') || '/pendaftaran'
      navigate(returnPage)
    }
  }, [location, navigate])
    ...
    try {
      ...
      if (isCompressibleImage) {
        try {
          ...
          fileToUse = await compressImage(editedFile, 1)
