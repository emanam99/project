    ...
    <div className="space-y-3.5 max-w-xl">
      <section className="ui-card p-3 space-y-3">
        <div className="flex items-start justify-between gap-2">
          <div>
            <h2 className="ui-section-title">Aplikasi (PWA)</h2>
      ...
      <section className="ui-card p-3 space-y-3">
        <div>
          <h2 className="ui-section-title">Tema</h2>
          <p className="text-[12.5px] text-muted mt-0.5">Pilih mode gelap atau terang.</p>
        </div>
      ...
      <section className="ui-card p-3 space-y-3">
        <div>
          <h2 className="ui-section-title">Ukuran teks</h2>
          <p className="text-[12.5px] text-muted mt-0.5">
            {fontSizeLabel}
            {' · '}
