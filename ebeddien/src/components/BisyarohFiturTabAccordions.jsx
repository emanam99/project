import { BISYAROH_TAB_ACCORDIONS, groupBisyarohFiturChildren } from '../config/bisyarohFiturCodes'

/**
 * Mengelompokkan aksi fitur menu Bisyaroh ke accordion per tab (Rekap, Histori, Aturan).
 */
export default function BisyarohFiturTabAccordions({
  children,
  openKeys,
  onToggleKey,
  renderRow,
  ...
  const buckets = groupBisyarohFiturChildren(children)
  const sections = BISYAROH_TAB_ACCORDIONS.map((def) => ({
    ...def,
