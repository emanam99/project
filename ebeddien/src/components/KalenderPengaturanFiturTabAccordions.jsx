import {
  KALENDER_PENGATURAN_TAB_ACCORDIONS,
  groupKalenderPengaturanFiturChildren
...
export default function KalenderPengaturanFiturTabAccordions({
  ...
  const buckets = groupKalenderPengaturanFiturChildren(children)
  const sections = KALENDER_PENGATURAN_TAB_ACCORDIONS.map((def) => ({
    ...def,
