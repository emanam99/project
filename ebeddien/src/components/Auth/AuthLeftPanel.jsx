...
/**
 * Panel kiri shared untuk halaman auth (login / daftar / lupa-password).
 * Hanya tampil di mode PC (md+). Tidak ikut flip saat pindah halaman.
 */
      ...
      <div className="relative z-10 flex flex-col justify-center items-start px-14 text-white">
        ...
        >
          <motion.img
            ...
            alt="eBeddien"
            className="max-w-[200px] w-auto h-20 mb-4 drop-shadow-2xl object-contain"
          ...
          <motion.img
            ...
            alt="eBeddien"
            className="max-w-[200px] w-auto h-16 mb-2 object-contain drop-shadow-lg"
            whileHover={{ scale: 1.03 }}
            transition={{ type: 'spring', stiffness: 300 }}
          />
