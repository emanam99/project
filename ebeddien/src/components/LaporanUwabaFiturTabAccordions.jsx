import { LAPORAN_TAB_ACCORDIONS, groupLaporanUwabaFiturChildren } from '../config/laporanFiturCodes'

/** Accordion aksi menu Laporan UWABA (/laporan — tab Tunggakan, Khusus, UWABA, Pendaftaran). */
export default function LaporanUwabaFiturTabAccordions({
  children,
  openKeys,
  onToggleKey,
  renderRow,
  ...
  const buckets = groupLaporanUwabaFiturChildren(children)
  const sections = LAPORAN_TAB_ACCORDIONS.map((def) => ({
    ...def,
