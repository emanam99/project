import { UGT_KOMPAS_TAB_ACCORDIONS, groupUgtKompasFiturChildren } from '../config/ugtKompasFiturCodes'

/** Accordion aksi menu KOMMPAS (tab + tambah/ubah/hapus per tab). */
export default function UgtKompasFiturTabAccordions({
  children,
  openKeys,
  onToggleKey,
  renderRow,
  ...
  const buckets = groupUgtKompasFiturChildren(children)
  const sections = UGT_KOMPAS_TAB_ACCORDIONS.map((def) => ({
    ...def,
