...
function PaymentHistoryOffcanvas({ isOpen, onClose, idSantri, mode = 'uwaba' }) {
  ...
  const fetchPaymentHistory = async () => {
    ...
    try {
      ...
      // UWABA: backend memakai tahun_ajaran=all untuk semua tahun. Khusus/tunggakan mengabaikan nilai ini;
      // tetap 'all' agar tidak bergantung localStorage/header TA (halaman publik).
      const tahunAjaranParam = 'all'
      const url = appendPublicPaymentTokenQuery(
        `${apiBaseUrl}/public/pembayaran/${mode}/history?id_santri=${idSantri}&tahun_ajaran=${encodeURIComponent(tahunAjaranParam)}`
      )
