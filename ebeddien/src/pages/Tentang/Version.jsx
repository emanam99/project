          ...
          {hasMore && (
            ...
            >
              <button
                type="button"
                onClick={loadMore}
                className="px-5 py-2.5 rounded-xl text-sm font-semibold text-primary-800 dark:text-primary-100 bg-primary-50 dark:bg-primary-900/45 hover:bg-primary-100 dark:hover:bg-primary-900/70 border border-primary-200/90 dark:border-primary-700/70 transition-colors"
              >
                Muat lebih banyak
              </button>
            </motion.div>
