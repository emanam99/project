...
export const EXPORT_COLUMNS = [
  { key: 'id', label: 'ID' },
  { key: 'identitas', label: 'Identitas madrasah' },
  { key: 'nama', label: 'Nama' },
  ...
  { key: 'kegiatan_pagi_mulai', label: 'Jam Pagi Mulai' },
  { key: 'kegiatan_pagi_sampai', label: 'Jam Pagi Sampai' },
  { key: 'kegiatan_sore', label: 'Kegiatan Siang' },
  { key: 'kegiatan_sore_mulai', label: 'Jam Siang Mulai' },
  { key: 'kegiatan_sore_sampai', label: 'Jam Siang Sampai' },
  { key: 'kegiatan_malam', label: 'Kegiatan Malam' },
  { key: 'kegiatan_malam_mulai', label: 'Jam Malam Mulai' },
  { key: 'kegiatan_malam_sampai', label: 'Jam Malam Sampai' },
  { key: 'kegiatan_mulai', label: 'Jam Mulai (legacy)' },
  { key: 'kegiatan_sampai', label: 'Jam Sampai (legacy)' },
