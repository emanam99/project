...
export default function LaporanGTPage() {
  ...
  const loadList = useCallback(async () => {
    ...
    try {
      ...
      const res = await ugtLaporanGtAPI.getAll(params)
        ...
        >
          {loading ? (
            ...
            <div className="p-8 text-center text-gray-500 dark:text-gray-400 text-sm">
              Belum ada laporan GT. Klik &quot;Tambah laporan&quot; untuk mengisi.
            </div>
          ) : (
                ...
                <tbody>
                  {list.map((row) => (
                    <tr
                      ...
                      aria-label={`Buka ubah laporan GT: ${row.madrasah_nama || ''} — ${row.santri_nama || ''}`}
