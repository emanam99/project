...
const BULK_FIELDS = [
  ...
  { key: 'kegiatan_pagi_mulai', label: 'Jam Pagi Mulai', type: 'text' },
  { key: 'kegiatan_pagi_sampai', label: 'Jam Pagi Sampai', type: 'text' },
  { key: 'kegiatan_sore', label: 'Kegiatan Siang', type: 'checkbox' },
  { key: 'kegiatan_sore_mulai', label: 'Jam Siang Mulai', type: 'text' },
  { key: 'kegiatan_sore_sampai', label: 'Jam Siang Sampai', type: 'text' },
  { key: 'kegiatan_malam', label: 'Kegiatan Malam', type: 'checkbox' },
  { key: 'kegiatan_malam_mulai', label: 'Jam Malam Mulai', type: 'text' },
  { key: 'kegiatan_malam_sampai', label: 'Jam Malam Sampai', type: 'text' },
  { key: 'tempat', label: 'Tempat', type: 'text' },
  { key: 'berdiri_tahun', label: 'Berdiri Tahun', type: 'text' },
  { key: 'tingkatan', label: 'Tingkatan (label dipisah koma)', type: 'text' },
    ...
    for (const id of ids) {
      try {
        ...
        const payload = {
          ...
          tingkatan:
            selectedField === 'tingkatan'
              ? value
              : tingkatanSlugsFromMadrasah(item),
          ...
          kegiatan_pagi_mulai: selectedField === 'kegiatan_pagi_mulai' ? value : (item?.kegiatan_pagi_mulai ?? null),
          kegiatan_pagi_sampai: selectedField === 'kegiatan_pagi_sampai' ? value : (item?.kegiatan_pagi_sampai ?? null),
          kegiatan_sore: selectedField === 'kegiatan_sore' ? (checkboxValue ? 1 : 0) : (item?.kegiatan_sore ? 1 : 0),
          kegiatan_sore_mulai: selectedField === 'kegiatan_sore_mulai' ? value : (item?.kegiatan_sore_mulai ?? null),
          kegiatan_sore_sampai: selectedField === 'kegiatan_sore_sampai' ? value : (item?.kegiatan_sore_sampai ?? null),
          kegiatan_malam: selectedField === 'kegiatan_malam' ? (checkboxValue ? 1 : 0) : (item?.kegiatan_malam ? 1 : 0),
          kegiatan_malam_mulai: selectedField === 'kegiatan_malam_mulai' ? value : (item?.kegiatan_malam_mulai ?? null),
          kegiatan_malam_sampai: selectedField === 'kegiatan_malam_sampai' ? value : (item?.kegiatan_malam_sampai ?? null),
  ...
  const content = (
    <AnimatePresence>
      ...
      <motion.div
        ...
        className="fixed top-0 right-0 bottom-0 w-full max-w-md bg-white dark:bg-gray-800 shadow-xl z-[100021] flex flex-col"
      >
