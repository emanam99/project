...
import PortraitGuideSilhouette from '../../../components/CameraScanner/PortraitGuideSilhouette'

/** Rasio pas foto 3×4 — area crop lebih lebar (hampir full panel). */
const ASPECT_W = 3
const ASPECT_H = 4
const VIEW_W = typeof window !== 'undefined'
  ? Math.min(360, Math.max(280, Math.floor(window.innerWidth - 48)))
  : 320
...
/** Offcanvas crop foto santri 3×4 — geser, zoom, rotasi (selaras UX foto profil). */
export default function CetakKartuSantriFotoCropModal({ file, onConfirm, onCancel, zBase = 320 }) {
            ...
            <div className="flex-1 overflow-y-auto overscroll-contain px-4 py-4">
              {preview ? (
                <>
                  <div
                    ref={containerRef}
                    className="crop-drag-area relative mx-auto overflow-hidden rounded-lg border-2 border-dashed border-teal-400/70 bg-gray-100 touch-none dark:bg-gray-700"
                  ...
                  >
                    <img
                      ...
                      draggable={false}
                    />
                    <PortraitGuideSilhouette
                      className="z-[1]"
                      strokeClassName="stroke-teal-600/55 dark:stroke-teal-300/60"
                    />
                  </div>
                  <p className="mt-2 text-center text-xs text-gray-500 dark:text-gray-400">
                    Sejajarkan wajah dengan siluet kepala &amp; bahu
                  </p>
