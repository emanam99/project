...
function TunggakanDashboard({ data }) {
  if (!data) return null
  
  const { total, bayar, kurang, kelompok, perBulan } = data
  ...
  const lineData = perBulan && perBulan.labels ? {
    labels: perBulan.labels.map(label => {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {lineData && (
          ...
          >
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4">
              Trend Pembayaran (12 Bulan Terakhir)
            </h3>
            <div style={{ height: '300px' }}>
...
export default TunggakanDashboard
