/**
 * Konfigurasi kolom export Manage Data Khusus.
 * Key = field di objek row, label = header di file Excel.
 * Urutan mengikuti kolom tabel Khusus.
 */
export const EXPORT_STORAGE_KEY = 'manageDataKhususExportColumns'
