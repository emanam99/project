...
export const EXPORT_COLUMNS = [
  ...
  { key: 'an_jatim', label: 'An. Rekening Jatim' },
...
/** Kolom numerik (dieksport sebagai angka, bukan teks). */
export const NUMERIC_KEYS = ['grup', 'tahun_lulus', 'jarak']

export function formatExportNumericValue(value, key) {
