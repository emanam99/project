...
function ItemRekap() {
  ...
  const {
    selectedHijriyah: selectedTahunHijriyah,
    setSelectedHijriyah: setSelectedTahunHijriyah,
    selectedMasehi: selectedTahunMasehi,
    setSelectedMasehi: setSelectedTahunMasehi,
    hijriyahOptions: hijriyahFilterOptions,
    masehiOptions: masehiFilterOptions
