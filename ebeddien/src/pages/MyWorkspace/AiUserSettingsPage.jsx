...
/** Selaras tab Pengaturan / Bank Q&A: border, fokus primary (teal tema), dark mode */
const fieldClass =
  'rounded-xl border border-gray-200 bg-white px-3 py-2.5 text-sm text-gray-900 shadow-sm transition placeholder:text-gray-400 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 dark:placeholder:text-gray-500 dark:focus:border-primary-400 dark:focus:ring-primary-400/25'

const ghostBtnClass =
  'rounded-lg border border-gray-300 bg-white px-2 py-1 text-sm font-medium text-gray-800 shadow-sm transition hover:bg-gray-50 disabled:opacity-50 dark:border-gray-600 dark:bg-gray-800/90 dark:text-gray-200 dark:hover:bg-gray-700/60'
      ...
      <div className="chat-scrollbar min-h-0 flex-1 overflow-y-auto overflow-x-hidden overscroll-contain p-3 sm:p-5">
        ...
        >
          <header className="mb-6">
            <h1 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Pengaturan User AI</h1>
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Limit harian, status aktif, dan pencarian pengguna.</p>
          </header>
          ...
          <div className="mb-4 flex flex-wrap gap-2">
            <input
              ...
              className={`flex-1 min-w-[220px] ${fieldClass} dark:[color-scheme:dark]`}
            />
            <select
              ...
              className={`min-w-[10.5rem] ${fieldClass} dark:[color-scheme:dark]`}
            >
          ...
          {adminAiUsersLoading ? (
            ...
            <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800/90">
              <div className="border-b border-gray-200/90 bg-gray-50/90 px-4 py-3 dark:border-gray-600 dark:bg-gray-900/40">
                <p className="text-xs font-semibold text-gray-900 dark:text-gray-100">Aturan limit harian (berlaku untuk daftar di bawah)</p>
                <ul className="mt-2 list-disc space-y-1 pl-4 text-xs text-gray-600 dark:text-gray-300">
                  <li>
                    <strong className="font-semibold text-gray-800 dark:text-gray-200">Limit</strong> = maksimal interaksi AI per{' '}
                    <strong className="font-semibold text-gray-800 dark:text-gray-200">hari kalender</strong> (reset mengikuti waktu server), dihitung
                    per pasangan pertanyaan → jawaban.
                  </li>
                  <li>
                    Kolom <strong className="font-semibold text-gray-800 dark:text-gray-200">pemakaian</strong> menampilkan{' '}
                    <code className="rounded border border-gray-200/80 bg-white px-1 font-mono text-[11px] text-gray-800 dark:border-gray-600 dark:bg-gray-800/80 dark:text-gray-200">
                      sudah dipakai / batas
                    </code>{' '}
                    hari ini untuk baris tersebut.
                  </li>
                  <li>
                    Beberapa akun dengan <strong className="font-semibold text-gray-800 dark:text-gray-200">nomor WhatsApp sama</strong> (setelah
                    dinormalisasi) dapat <strong className="font-semibold text-gray-800 dark:text-gray-200">berbagi satu ember</strong> pemakaian di{' '}
                    <strong className="font-semibold text-gray-800 dark:text-gray-200">aplikasi web</strong>.
                  </li>
                  <li>
                    Nilai <strong className="font-semibold text-gray-800 dark:text-gray-200">0</strong> = tidak ada kuota harian (permintaan AI akan
                    ditolak). Nonaktifkan akses lebih rapi lewat toggle <strong className="font-semibold text-gray-800 dark:text-gray-200">AI aktif</strong>.
                  </li>
                </ul>
              </div>
              <ul className="divide-y divide-gray-200 dark:divide-gray-700">
                {adminAiUsers.map((u) => (
                  <li key={u.id} className="px-4 py-3 transition-colors hover:bg-gray-50/90 dark:hover:bg-gray-900/35">
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                      <div className="min-w-0">
                        ...
                        <p className="mt-1 text-xs text-gray-600 dark:text-gray-300">
                          <span className="font-medium text-gray-800 dark:text-gray-200">Pemakaian hari ini:</span>{' '}
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        <button
                          ...
                          className="inline-flex items-center gap-1 rounded-lg border border-primary-200 bg-primary-50 px-2.5 py-1.5 text-xs font-medium text-primary-800 shadow-sm transition hover:bg-primary-100 dark:border-primary-700/50 dark:bg-primary-950/35 dark:text-primary-100 dark:hover:bg-primary-900/45"
                        >
                          Ubah limit
          ...
          {adminAiUsersTotal > adminAiUsersLimit && (
            <div className="mt-4 flex flex-wrap items-center justify-between gap-2 text-sm">
              ...
              <div className="flex gap-2">
                ...
                <span className="self-center text-gray-600 dark:text-gray-300">Halaman {adminAiUsersPage}</span>
                <button
                  type="button"
        ...
        {editAiUser ? (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-x-0 bottom-0 z-[121] flex max-h-[min(88dvh,560px)] flex-col rounded-t-2xl border border-gray-200 bg-white shadow-[0_-8px_30px_rgba(0,0,0,0.12)] dark:border-gray-700 dark:bg-gray-900 dark:shadow-[0_-8px_30px_rgba(0,0,0,0.45)]"
            ...
            >
              ...
              <div className="flex shrink-0 items-start justify-between gap-3 border-b border-gray-200 px-4 pb-3 pt-1 dark:border-gray-700">
                ...
                <button
                  ...
                  className="shrink-0 rounded-lg p-2 text-gray-500 transition hover:bg-gray-100 disabled:opacity-50 dark:text-gray-400 dark:hover:bg-gray-800"
                  aria-label="Tutup"
                >
              ...
              <div className="min-h-0 flex-1 overflow-y-auto px-4 py-4">
                ...
                <input
                  ...
                  className={`w-full ${fieldClass} dark:[color-scheme:dark]`}
                />
              </div>
              <div className="shrink-0 border-t border-gray-200 px-4 pt-3 dark:border-gray-700">
                <div className="flex gap-2">
                  <button
                    ...
                    onClick={closeLimitOffcanvas}
                    disabled={editAiUserBusy}
                    className="flex-1 rounded-xl border border-gray-300 bg-white py-2.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 disabled:opacity-50 dark:border-gray-600 dark:bg-gray-800/90 dark:text-gray-200 dark:hover:bg-gray-700/50"
                  >
                    Batal
                  </button>
                  <button
                    ...
                    disabled={editAiUserBusy}
                    className="flex-1 rounded-xl bg-primary-600 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-primary-700 disabled:opacity-50 dark:bg-primary-500 dark:hover:bg-primary-600"
                  >
