 ...
 * - ebeddien.alutsmani.my.id / ebeddien2.alutsmani.id (staging) → https://live2.alutsmani.id
...
export function getLiveServerUrl() {
  ...
  if (
    host === 'ebeddien2.alutsmani.id'
    || host === 'ebeddien.alutsmani.my.id'
    || host === 'alutsmani.my.id'
    || host.endsWith('.alutsmani.my.id')
  ) return 'https://live2.alutsmani.id'
