/** Kode menu induk di app___fitur (accordion khusus di halaman Fitur). */
export const PENGURUS_MENU_CODE = 'menu.pengurus'
...
export const PENGURUS_ACTION_CODES = {
  ...
  edit: 'action.pengurus.edit',
  import: 'action.pengurus.import',
  /** Editor spreadsheet (FortuneSheet), selaras halaman Santri. */
  excel: 'action.pengurus.excel',
