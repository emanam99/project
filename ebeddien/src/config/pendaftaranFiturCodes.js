...
export const PENDAFTARAN_ACTION_CODES = {
  ...
  tesMasukSimpan: 'action.pendaftaran.tes_masuk.simpan',
  tesMasukCetak: 'action.pendaftaran.tes_masuk.cetak',
  tesMasukAktifDiniyah: 'action.pendaftaran.tes_masuk.aktif_diniyah',
  tesMasukVerifikasi: 'action.pendaftaran.tes_masuk.verifikasi',
  ...
  nisPengajuanKelola: 'action.pendaftaran.nis_pengajuan.kelola',
  nisPengajuanKirim: 'action.pendaftaran.nis_pengajuan.kirim_nis',
  nisPengajuanEdit: 'action.pendaftaran.nis_pengajuan.edit_data',
}
