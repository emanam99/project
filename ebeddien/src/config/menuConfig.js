...
export const MENU_ITEMS = [
  ...
  // ========== Domisili ==========
  { path: '/domisili/daerah', label: 'Daerah', iconKey: 'mapPin', group: 'Domisili', requiresSuperAdmin: true },
  { path: '/domisili/kamar', label: 'Kamar', iconKey: 'homeRoom', group: 'Domisili', requiresSuperAdmin: true },
  // ========== Lembaga ==========
