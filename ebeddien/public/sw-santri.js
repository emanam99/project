...
// Jangan cache respons API publik di SW (bisa berisi data sensitif + view_token).
registerRoute(
  /\/backend\/public\/.*/i,
  new NetworkOnly()
)
...
self.addEventListener('push', (event) => {
  ...
  const options = {
    body,
    icon: payload.icon || 'https://gambar.alutsmani.id/icon/icon192.png',
    badge: payload.badge || 'https://gambar.alutsmani.id/icon/icon128.png',
