...
/**
 * Modal pengingat daftar passkey (setelah login password — interval dari backend).
 */
    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          role="dialog"
          aria-modal="true"
          aria-labelledby="passkey-prompt-title-mybeddian"
        >
          <motion.div
          ...
          >
            <div className="px-5 pt-5 pb-2">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h2 id="passkey-prompt-title-mybeddian" className="text-lg font-semibold text-gray-900 dark:text-gray-100">
