...
export default function UbahPassword() {
  ...
  if (valid === null) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#1761ac] dark:bg-[#0d3d66]">
      ...
      tokenCheckHint === 'tidak_ada'
        ...
        : tokenCheckHint === 'jaringan'
          ...
          : tokenCheckHint === 'tidak_berlaku'
            ? 'Link sudah kadaluarsa (aktif 10 menit) atau sudah dipakai. Silakan minta link baru dari Lupa password.'
            : tokenCheckHint && tokenCheckHint !== 'server'
              ? tokenCheckHint
              : 'Link sudah kadaluarsa (aktif 10 menit) atau sudah dipakai. Silakan minta link baru dari Lupa password.'
    return (
      <div className="min-h-screen flex items-center justify-center p-4 bg-[#1761ac] dark:bg-[#0d3d66]">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          <a href="/lupa-password" className="inline-block py-2 px-4 rounded-xl bg-primary-600 text-white font-medium hover:bg-primary-700">
            Ke Lupa password
          </a>
        </motion.div>
      </div>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#1761ac] dark:bg-[#0d3d66]">
      ...
      >
        ...
        {nama && <p className="text-gray-600 dark:text-gray-400 text-sm mb-2">Halo, {nama}</p>}
        <p className="text-xs text-gray-500 dark:text-gray-400 mb-6">
          Password minimal {PASSWORD_MIN} karakter. Ketik ulang di konfirmasi; tidak bisa tempel.
        </p>
