    ...
    <div className="max-w-2xl mx-auto px-4 py-6 pb-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
        ...
        <button
          type="button"
          onClick={openTambah}
          className="px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-xl text-sm font-medium shrink-0"
        >
          + Tambah Barang
        </button>
      </div>
          ...
          {list.map((b) => (
            ...
            >
              <div className="min-w-0 flex-1">
                ...
                <p className="text-sm text-primary-600 dark:text-primary-400 mt-0.5">{formatRupiah(b.harga)}</p>
                {b.keterangan && (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <button
                    type="submit"
                    disabled={saving}
                    className="flex-1 px-4 py-2.5 bg-primary-600 hover:bg-primary-700 text-white rounded-lg disabled:opacity-50"
                  >
