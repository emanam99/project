              ...
              >
                ...
                >
                  ...
                  <div className="flex-1 flex flex-wrap items-center justify-end gap-x-3 gap-y-1 text-xs min-w-0 text-right">
                    ...
                    <span className="text-green-600 dark:text-green-400">Bayar {formatCurrency(r.bayar)}</span>
                    <span
                        ...
                        <section>
                          ...
                          <div className="grid grid-cols-3 gap-2 sm:gap-3">
                            ...
                            <div className="rounded-xl bg-green-50 dark:bg-green-900/20 p-2.5 sm:p-3 text-center">
                              ...
                              <p className="text-xs sm:text-sm font-semibold text-green-700 dark:text-green-300 truncate" title={formatCurrency(r.bayar)}>{formatCurrency(r.bayar)}</p>
                            </div>
