  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-4 sm:py-6 pb-8">
      <Link
        ...
        className="inline-flex items-center gap-2 text-sm text-teal-600 dark:text-teal-400 hover:underline mb-4 sm:mb-6"
      >
              ...
              >
                ...
                >
                  ...
                  <div className="flex-1 flex flex-wrap items-center justify-end gap-x-3 gap-y-1 text-xs min-w-0 text-right">
                    ...
                    <span className="text-green-600 dark:text-green-400">Bayar {formatCurrency(tot.bayar)}</span>
                    ...
                    <section>
                      ...
                      <div className="grid grid-cols-3 gap-2 sm:gap-3">
                        ...
                        <div className="rounded-xl bg-green-50 dark:bg-green-900/20 p-2.5 sm:p-3 text-center">
                          <p className="text-[10px] sm:text-xs text-green-600 dark:text-green-400 mb-0.5">Bayar</p>
                          <p className="text-xs sm:text-sm font-semibold text-green-700 dark:text-green-300 truncate" title={formatCurrency(tot.bayar)}>{formatCurrency(tot.bayar)}</p>
                        </div>
                    ...
                    {(tot.kurang ?? 0) > 0 && (
                      <div className="grid grid-cols-3 gap-2 sm:gap-3 items-center">
                        ...
                        <button
                          ...
                          className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-teal-600 hover:bg-teal-700 text-white text-sm font-medium rounded-xl shadow-sm"
                        >
                            ...
                            <tbody className="divide-y divide-gray-100 dark:divide-gray-700/50">
                              {data.rincian.map((row) => (
                                <tr key={row.id || row.id_bulan} className="text-gray-800 dark:text-gray-200">
                                  ...
                                  <td className="py-1.5 px-2 sm:px-3 text-right text-green-600 dark:text-green-400">{formatCurrency(row.bayar)}</td>
