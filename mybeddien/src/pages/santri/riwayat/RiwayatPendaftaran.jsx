...
import { useSantriIds, useSantriRegistrasi } from '../../../hooks/useSantriCachedResources'
...
export default function RiwayatPendaftaran() {
  ...
  const { registrasi, loading } = useSantriRegistrasi()
  ...
  return (
    <PageEnter className="max-w-2xl mx-auto px-4 sm:px-6 py-4 sm:py-6 pb-8">
      <PageEnterTitle className="mb-4 sm:mb-6">
        ...
        <h1 className="text-xl font-semibold text-gray-900 dark:text-white tracking-tight">Pendaftaran (Registrasi)</h1>
      </PageEnterTitle>
