...
import { useSantriIds, useSantriTunggakanBundle } from '../../../hooks/useSantriCachedResources'
...
export default function RiwayatTunggakan() {
  ...
  const { bundle, loading } = useSantriTunggakanBundle()
  ...
  return (
    <PageEnter className="max-w-2xl mx-auto px-4 sm:px-6 py-3 sm:py-4 pb-6">
      <PageEnterTitle className="mb-3">
        ...
        <h1 className="text-lg font-semibold text-gray-900 dark:text-white tracking-tight">Tunggakan</h1>
      </PageEnterTitle>
