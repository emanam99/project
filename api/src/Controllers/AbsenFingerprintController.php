 ...
 * Opsional .env: ABSEN_FINGERPRINT_ALLOWED_SN=SN1,SN2 (kosong = semua mesin) |
 * ABSEN_FINGERPRINT_SECRET=... (&key=... di URL; kosong = tanpa secret)
 */
class AbsenFingerprintController
{
    ...
    private function gateRequest(Request $request, Response $response): ?Response
    {
        ...
        // Secret opsional: hanya dicek jika ABSEN_FINGERPRINT_SECRET diisi.
        // SN whitelist opsional: jika ABSEN_FINGERPRINT_ALLOWED_SN kosong, semua mesin diizinkan
        // (cocok untuk beberapa kantor / beberapa mesin tanpa konfigurasi ketat).
