...
class AppFiturController
{
    ...
    private const LEMBAGA_HALAMAN_ACTION_TO_MENU = [
        ...
        'action.rombel.filter.semua_rombel_lembaga' => 'menu.rombel',
        'action.rombel.rombel_bertugas' => 'menu.rombel',
        'action.manage_jabatan.halaman' => 'menu.manage_jabatan',
        'action.mapel.halaman' => 'menu.mapel',
        'action.bisyaroh.halaman' => 'menu.bisyaroh',
        'action.domisili.pelanggaran.halaman' => 'menu.domisili.pelanggaran',
        // Alumni (ISBAD): aksi tanpa menu induk tetap muncul di sidebar / Semua Menu
        'action.alumni.edit' => 'menu.alumni',
        'action.alumni.hapus' => 'menu.alumni',
        'action.alumni.status' => 'menu.alumni',
    ];
