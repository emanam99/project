...
final class EbeddienFiturAccess
{
    ...
    {
        return EbeddienFiturSelectorRepository::codesForMethod('userDetailReadonlySelectors');
    }
    ...
    {
        return EbeddienFiturSelectorRepository::codesForMethod('santriListApiSelectors');
    }
    ...
    {
        return EbeddienFiturSelectorRepository::codesForMethod('santriRiwayatRombelDeleteApiSelectors');
    }
    ...
    {
        return EbeddienFiturSelectorRepository::codesForMethod('pengurusExcelApiSelectors');
    }
    ...
    {
        return EbeddienFiturSelectorRepository::codesForMethod('domisiliPelanggaranAdminApiSelectors');
    }
    ...
    {
        return EbeddienFiturSelectorRepository::codesForMethod('psbTesMasukMenus');
    }

    public static function psbPanitiaTesApiSelectors(): array
    {
        return EbeddienFiturSelectorRepository::codesForMethod('psbPanitiaTesApiSelectors');
    }
    ...
    {
        return EbeddienFiturSelectorRepository::codesForMethod('santriBiodataLttqOptionsSelectors');
    }
    ...
    {
        return EbeddienFiturSelectorRepository::codesForMethod('installActivitySelectors');
    }
    ...
    {
        return EbeddienFiturSelectorRepository::codesForMethod('bisyarohApiSelectors');
    }

    public static function ugtGuruTugasTugasanApiSelectors(): array
    {
        return EbeddienFiturSelectorRepository::codesForMethod('ugtGuruTugasTugasanApiSelectors');
    }

    public static function websiteAdminApiSelectors(): array
    {
        return EbeddienFiturSelectorRepository::codesForMethod('websiteAdminApiSelectors');
    }

    public static function lttqStaffApiSelectors(): array
    {
        return EbeddienFiturSelectorRepository::codesForMethod('lttqStaffApiSelectors');
    }

    public static function alumniStaffApiSelectors(): array
    {
        return EbeddienFiturSelectorRepository::codesForMethod('alumniStaffApiSelectors');
    }
}
