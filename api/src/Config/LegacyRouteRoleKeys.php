...
final class LegacyRouteRoleKeys
{
    ...
    public const KALENDER_PENGATURAN_LOKASI_SELECTORS = 'kalenderPengaturanLokasiSelectors';

    public const ABSEN_ALAMAT_CRUD_API_SELECTORS = 'absenAlamatCrudApiSelectors';
    ...
    /** GET /api/santri — PSB/tarbiyah + staff ijin (baca indeks). */
    public const SANTRI_LIST_API_SELECTORS = 'santriListApiSelectors';
    ...
    public const USER_DETAIL_READONLY_SELECTORS = 'userDetailReadonlySelectors';
    ...
    public const INSTALL_ACTIVITY_SELECTORS = 'installActivitySelectors';

    /** Modul admin Website (berita, banner, halaman, galeri, SEO). */
    public const WEBSITE_ADMIN_SELECTORS = 'websiteAdminSelectors';

    /** Modul LTTQ (tingkatan, mualim, santri LTTQ). */
    public const LTTQ_STAFF_SELECTORS = 'lttqStaffSelectors';

    /** Panitia tes masuk PSB — akses terbatas ke halaman Tes Masuk. */
    public const PSB_PANITIA_TES_SELECTORS = 'psbPanitiaTesApiSelectors';
}
