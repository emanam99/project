...
return function (\Slim\App $app): void {
    $app->group('/api/deepseek', function ($group) {
        ...
        /** Chat alternatif Google Gemini (generateContent) — butuh GEMINI_API_KEY di server. */
        $group->post('/gemini-chat', [DeepseekController::class, 'directGeminiApiChat']);
        ...
        $group->put('/api-provider-preference', [DeepseekController::class, 'putApiProviderPreference']);
        ...
        /** Agen otomasi (RBAC fitur action.chat_ai.agent.*, konfirmasi + rollback) */
        $group->post('/agent/turn', [AiAgentController::class, 'agentTurn']);
        $group->post('/agent/confirm', [AiAgentController::class, 'agentConfirm']);
        $group->post('/agent/rollback', [AiAgentController::class, 'agentRollback']);
        $group->post('/agent/discard', [AiAgentController::class, 'agentDiscard']);
        $group->get('/agent/job/{id}', [AiAgentController::class, 'agentGetJob']);
