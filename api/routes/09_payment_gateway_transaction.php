...
return function (\Slim\App $app): void {
    $app->group('/api/payment-gateway', function ($group) {
        ...
        $group->get('/mybeddian-provider', [PaymentGatewayController::class, 'getMybeddianProvider']);
        $group->put('/mybeddian-provider', [PaymentGatewayController::class, 'putMybeddianProvider']);
    ...
    $app->group('/api/payment-transaction', function ($group) {
        ...
        $group->post('/{id}/send-wa', [PaymentTransactionController::class, 'sendWaNotification']);
    ...
    $app->post('/api/payment-transaction/callback/xendit', [PaymentTransactionController::class, 'handleXenditCallback']);
