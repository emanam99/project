...
use App\Controllers\MadrasahEditPengajuanController;
...
return function (\Slim\App $app): void {
    ...
    $app->group('/api/ugt/madrasah-edit-pengajuan', function ($group) {
        $group->get('', [MadrasahEditPengajuanController::class, 'getAll']);
        $group->get('/{id}', [MadrasahEditPengajuanController::class, 'getById']);
        $group->put('/{id}', [MadrasahEditPengajuanController::class, 'update']);
        $group->post('/{id}/approve', [MadrasahEditPengajuanController::class, 'approve']);
        $group->post('/{id}/reject', [MadrasahEditPengajuanController::class, 'reject']);
    })->add(new EbeddienFiturMiddleware(EbeddienFiturAccess::ugtMenus(), LegacyRouteRoles::forKey(LegacyRouteRoleKeys::UGT_MENUS)))->add(new AuthMiddleware());
