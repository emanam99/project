...
return function (\Slim\App $app): void {
    $app->group('/api/settings', function ($group) {
        ...
        $group->get('/roles/{roleId}/pengurus-checklist', [SettingsController::class, 'getRolePengurusChecklist']);
        $group->put('/roles/{roleId}/pengurus-checklist', [SettingsController::class, 'putRolePengurusChecklist']);
    ...
    $app->group('/api/evolution-api', function ($group) {
        ...
        $group->get('/instance/{name}/webhook', [EvolutionApiController::class, 'getWebhook']);
        $group->post('/instance/{name}/webhook', [EvolutionApiController::class, 'postSetWebhook']);
    ...
    $app->group('/api/user-aktivitas', function ($group) {
        $group->get('/overview', [UserAktivitasController::class, 'getOverview']);
        $group->get('/access-log', [UserAktivitasController::class, 'getAccessLog']);
