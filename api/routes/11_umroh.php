...
return function (\Slim\App $app): void {
    ...
    })->add(new EbeddienFiturMiddleware(EbeddienFiturAccess::umrohModuleSelectors(), LegacyRouteRoles::forKey(LegacyRouteRoleKeys::UMROH_MODULE_SELECTORS)))->add(new AuthMiddleware());
};
