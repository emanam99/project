...
class RoleSeed extends AbstractSeed
{
    ...
    private array $entries = [
        ...
        [36, 'admin_web', 'Admin Web'],
        [37, 'petugas_web', 'Petugas Web'],
        [38, 'conten_web', 'Konten Web'],
        [39, 'ubudiyah', 'Ubudiyah'],
        [40, 'wakil_ubudiyah', 'Wakil Ubudiyah'],
        [41, 'admin_lttq', 'Admin LTTQ'],
        [42, 'petugas_lttq', 'Petugas LTTQ'],
        [43, 'keuangan_lttq', 'Keuangan LTTQ'],
        [44, 'panitia_tes', 'Panitia Tes'],
    ];
