...
class AppFiturMenuSeed extends AbstractSeed
{
    ...
    private function menuRows(): array
    {
        return [
            ...
            ['path' => '/kalender-pesantren', 'label' => 'Jadwal Pesantren', 'iconKey' => 'calendar', 'group' => 'Kalender Pesantren'],
            ['path' => '/kalender-pesantren/kelola-event', 'label' => 'Kelola Event', 'iconKey' => 'plus', 'group' => 'Kalender Pesantren'],
            ['path' => '/kalender-pesantren/pengaturan', 'label' => 'Pengaturan Google Kalender', 'iconKey' => 'cog', 'group' => 'Kalender Pesantren'],
