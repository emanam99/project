...
class AppFiturMenuSeed extends AbstractSeed
{
    ...
    private function menuRows(): array
    {
        return [
            ...
            ['path' => '/dashboard-keuangan', 'label' => 'Dashboard Keuangan', 'iconKey' => 'chartPie', 'group' => 'Keuangan', 'requiresRole' => ['admin_uwaba', 'petugas_keuangan', 'super_admin'], 'requiresPermission' => 'manage_finance'],
            ['path' => '/pengeluaran', 'label' => 'Pengeluaran', 'iconKey' => 'cash', 'group' => 'Keuangan', 'requiresRole' => ['admin_uwaba', 'petugas_keuangan', 'super_admin']],
            ['path' => '/pemasukan', 'label' => 'Pemasukan', 'iconKey' => 'currency', 'group' => 'Keuangan', 'requiresRole' => ['admin_uwaba', 'petugas_keuangan', 'super_admin']],
            ['path' => '/aktivitas', 'label' => 'Aktivitas', 'iconKey' => 'clock', 'group' => 'Keuangan', 'requiresRole' => ['admin_uwaba', 'petugas_keuangan', 'super_admin']],
            ['path' => '/aktivitas-tahun-ajaran', 'label' => 'Aktivitas TA', 'iconKey' => 'chartStack', 'group' => 'Keuangan', 'requiresRole' => ['admin_uwaba', 'petugas_keuangan', 'super_admin']],
