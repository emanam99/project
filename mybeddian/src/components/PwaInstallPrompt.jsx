          ...
          <div className="rounded-2xl shadow-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 overflow-hidden">
            <div className="p-4 flex items-start gap-3">
              <div className="shrink-0 w-12 h-12 rounded-xl bg-teal-100 dark:bg-teal-900/40 flex items-center justify-center overflow-hidden">
                {!iconError ? (
                  <img
                    src={getGambarUrl('icon/mybeddian.png')}
                    alt="MyBeddian"
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400 mt-0.5">
                  Pasang MyBeddian di layar utama untuk akses lebih cepat dan pengalaman seperti aplikasi native.
                </p>
                ...
                {showManualHint && (
                  <p className="text-xs text-amber-600 dark:text-amber-400 mt-2">
                    Di Chrome: menu ⋮ → &quot;Install MyBeddian&quot; atau &quot;Pasang aplikasi&quot;. Di Safari (iPhone): tombol Bagikan → &quot;Tambahkan ke Layar Utama&quot;.
                  </p>
                )}
              </div>
              <button
