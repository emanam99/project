...
function InfoModal({ isOpen, onClose, fieldType }) {
  ...
  // Data info untuk setiap field type (CDN gambar/info → gambar.alutsmani.id)
  const infoData = {
    nik: {
      title: 'Informasi NIK',
      image: getGambarUrl('/info/nik.jpg'),
      description: (
        <>
    ...
    no_kk: {
      ...
      image: getGambarUrl('/info/no_kk.jpg'),
      description: (
        <>
          <p className="text-sm text-gray-600 dark:text-gray-300 mb-3">
    ...
    npsn: {
      ...
      image: getGambarUrl('/info/npsn.jpg'),
      description: (
        <>
          <p className="text-sm text-gray-600 dark:text-gray-300 mb-3">
    ...
    kip: {
      title: 'Informasi KIP',
      image: getGambarUrl('/info/kip.jpg'),
      description: (
        <>
          <p className="text-sm text-gray-600 dark:text-gray-300 mb-3">
    ...
    kks: {
      title: 'Informasi KKS',
      image: getGambarUrl('/info/kks.jpg'),
      description: (
        <>
          <p className="text-sm text-gray-600 dark:text-gray-300 mb-3">
    ...
    kepala_keluarga: {
      ...
      image: getGambarUrl('/info/kepala_keluarga.jpg'),
      description: (
        <>
          <p className="text-sm text-gray-600 dark:text-gray-300 mb-3">
