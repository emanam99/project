      ...
      <div className="flex gap-4 mb-4">
        ...
        <div>
          ...
          <input
            ...
            onBlur={onBlur}
            maxLength={6}
            className="w-24 p-2 border-b-2 border-gray-300 dark:border-gray-600 focus:border-teal-500 dark:focus:border-teal-400 focus:outline-none bg-transparent text-center text-gray-900 dark:text-gray-100"
          />
        </div>
      </div>
