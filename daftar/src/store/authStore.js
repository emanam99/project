...
import { ensureStorageNik, normalizeNisForStorage, persistDaftarUserData } from '../utils/clientStorage'
...
export const useAuthStore = create((set) => ({
  ...
  setAuth: (token, user) => {
    ...
    if (user) {
      ...
      persistDaftarUserData(normalizedUser)
      set({ 
        token, 
        user: normalizedUser, 
