...
import AlumniProtectedRoute from './components/Auth/AlumniProtectedRoute'
import AlumniLayout from './components/alumni/AlumniLayout'
import { NotificationProvider } from './contexts/NotificationContext'
import { UnsavedChangesProvider } from './contexts/UnsavedChangesContext'
import { isAlumniAppHost } from './config/alumniApp'
...
const AlumniNik = lazy(() => import('./pages/alumni/AlumniNik'))
const AlumniBiodata = lazy(() => import('./pages/alumni/AlumniBiodata'))
const AlumniTercatat = lazy(() => import('./pages/alumni/AlumniTercatat'))
...
const NotFound = () => {
  ...
  useEffect(() => {
    ...
    // Rute alumni: jangan lempar ke root domain (hilangkan /alumni)
...
/** Host alumni.alutsmani.id — hanya alur Pendataan Alumni (sama /alumni di daftar). */
function AlumniHostApp() {
  return (
    <NotificationProvider>
      <UnsavedChangesProvider>
        <Routes>
          ...
          {/* Link lama daftar…/alumni* → root host alumni */}
          <Route path="/alumni" element={<Navigate to="/" replace />} />
          <Route path="/alumni/biodata" element={<Navigate to="/biodata" replace />} />
          <Route path="/alumni/tercatat" element={<Navigate to="/tercatat" replace />} />
...
function App() {
  ...
  const alumniHost = isAlumniAppHost()
  ...
  return (
    <NotificationProvider>
      <UnsavedChangesProvider>
        ...
        {/* Pendaftaran Alumni — terpisah dari alur santri (juga di alumni.alutsmani.id) */}
        <Route element={<AlumniLayout />}>
          <Route
            path="/alumni"
            element={
