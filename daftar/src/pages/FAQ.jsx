            ...
            <div className="space-y-3">
              <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/40 px-4 py-3">
                ...
                <div className="flex flex-wrap items-center gap-2 justify-between">
                  <a href="mailto:alutsmanipps@gmail.com" className="text-sm font-medium text-teal-600 dark:text-teal-400 hover:underline break-all">
                    alutsmanipps@gmail.com
                  </a>
                  <button
                    type="button"
                    onClick={async () => {
                      try {
                        await navigator.clipboard.writeText('alutsmanipps@gmail.com')
                      } catch (_) {}
                    }}
                    className="shrink-0 inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg border border-gray-300 dark:border-gray-600 text-xs font-medium text-gray-700 dark:text-gray-200 hover:bg-white dark:hover:bg-gray-800"
                  >
                    Salin
                  </button>
                </div>
              ...
              <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/40 px-4 py-3">
                <p className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-1.5">WhatsApp / telepon</p>
                <div className="flex flex-wrap items-center gap-2 justify-between">
                  <div className="min-w-0">
                    <a
                      href="https://wa.me/6285123123399"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-sm font-medium text-teal-600 dark:text-teal-400 hover:underline font-mono"
                    >
                      085 - 123 - 123 - 399
                    </a>
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Ketuk nomor untuk membuka WhatsApp</p>
                  </div>
                  <button
                    type="button"
                    onClick={async () => {
                      try {
                        await navigator.clipboard.writeText('085123123399')
                      } catch (_) {}
                    }}
                    className="shrink-0 inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg border border-gray-300 dark:border-gray-600 text-xs font-medium text-gray-700 dark:text-gray-200 hover:bg-white dark:hover:bg-gray-800"
                  >
              ...
              <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/40 px-4 py-3">
                <p className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-1.5">Alamat</p>
                <div className="flex flex-wrap items-start gap-2 justify-between">
                  <p className="text-sm text-gray-900 dark:text-gray-100 leading-snug flex-1 min-w-0">
